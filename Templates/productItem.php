<div item="<?php echo 'ITEM_' . $item['id']; ?>" class="grid-item displayItem <?php echo htmlspecialchars(explode(" ",$item['nom'])[0], ENT_QUOTES, 'UTF-8'); ?> border"
    ...
    <div class="item py-2 px-2">
        <div class="product font-raleway w-100">
            <div class="text-center d-flex justify-content-center align-items-center flex-column w-100">
                <img style="height:10rem;width:100%;object-fit:cover;" src=".<?php echo htmlspecialchars($product['image_path'] , ENT_QUOTES, 'UTF-8'); ?>.png" alt="<?php echo htmlspecialchars($item['nom'], ENT_QUOTES, 'UTF-8'); ?>">
